...
//var shoesList = [];  commented this line
...
// Highlighted on clicked size box and push the value to an array 
...
//Function to display the total price of all products in the cart 
...
// Turn on the switch by passing current userInfo to it  ---
...
// Turn off the switch by eliminating current userInfo  ---
function logout() {
...
// Check the login status to decide which elements should be displayed  ---
function loginCheck() {
...
//  !!!  Very Important: Create login status in localstorage if it doesn't exsist   ---     
...
// Take the regirstration inputs and upload it to localstorage (Also log this user in)   ---
function register() {
...
// User inputs will be searched in localstorage, only matched info is allowed to login  ---
function login() {
...
//function for List Women Shoes in Women's section Web Page -  
function listWomenShoes() {
  ...
  for (let b of shoesList) {
    if (b.gender == 'Women') {
      ...
      model.textContent = b.modelname;
      const price = document.createElement('p');//Add price -- 
      price.textContent = "Price: $" + b.price;
...
//function for list men shoes in Men's section Web Page -  
...
//function for list men shoes filtered in Men's section Web Page -  
...
//Function to get the id of the product that the customer clicked -  
function getId() {
  ...
  //We get the product id and we call the function that loads product details -  
  var product = urlParams.get('product');
  productPage(product);
}

//Function to show the details of the product that the customer clicked -  
function productPage(idInput) {
  for (let b of shoesList) {
    if (b.id == idInput) {
      ...
      document.querySelector('#price').textContent = "Price: " + b.price;
